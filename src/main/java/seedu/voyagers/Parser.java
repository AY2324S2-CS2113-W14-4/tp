...
public class Parser {
    ...
    private SimpleDateFormat fullDateFormat = new SimpleDateFormat("dd MMMM yyyy");
    private ArrayList<Trip> tripsList;

    private static final Date DEFAULT_START = new Date(1900, 1, 1);
    private static final Date DEFAULT_END = new Date(2500, 1, 1);
    ...
    public void listAll() {
        ...
        for (int i = 0; i < tripsList.size(); i++) {
            ...
            String startDateStr = trip.getStartDate().equals(DEFAULT_START) ? "-" : fullDateFormat.format(trip.getStartDate());
            String endDateStr = trip.getEndDate().equals(DEFAULT_END) ? "-" : fullDateFormat.format(trip.getEndDate());
    ...
    private boolean confirmPartialInfo(String name, Date startDate, Date endDate, String location, String description) {
        if(!(name.isEmpty() || startDate == DEFAULT_START || endDate == DEFAULT_END || location.isEmpty() || description.isEmpty())) {
            return true;
        }
