...
public class Parser {
    ...
    private SimpleDateFormat printDateFormat = new SimpleDateFormat("dd MMMM yyyy");
    ...
    public Parser(ArrayList<Trip> tripsList) {
        ...
        try {
            DEFAULT_START = dateFormat.parse("1900-01-01");
            DEFAULT_END = dateFormat.parse("2500-12-31");
